...
if($_SESSION['permisos']!='1' && $_SESSION['permisos']!='2' && $_SESSION['permisos']!='3' ){
   ...
   $consulta = $cone->prepare("select * from equipos"); 
   $consulta->execute(); 
?>
                      ...
                      <form id="agregar_equipo"  method=post class="m-5 p-5" style="width:80%">
                          ...
                          <div class="form-group">
                                <div class="d-flex flex-column mb-3">
                                  <label class="m-3 text-center font-weight-bold">AGREGAR UNA EQUIPO</label>
   ...
   <?php
while ($equipos = $consulta->fetch(PDO::FETCH_ASSOC)) {

    echo '<div class="container">
      <div class="row my-5">                               
            <div class="col-sm-12 col-md-4 px-5">
                <div class="imagen-producto">
                    <img src="../img/equipos/'.$equipos['imagen'].'"> 
                </div>
            </div>
                ...
                <div class="col-sm-12 col-md-8">
                    <div class="d-flex flex-wrap justify-content-center align-content-center" style="height:100%"> 
                        <form id="actualizar_equipos" 
                              ...
                              style="height:100%">
                              <div class="form-group">
                              <textarea minlength=5 maxlength=300 class="form-control mt-1" id="descripcion" name="descripcion" placeholder="escriba un texto aqui" rows="4">'.$equipos['descripcion'].'</textarea>
                              <textarea minlength=5 maxlength=300 class="form-control mt-1" id="descripcioni" name="descripcioni" placeholder="escriba texto en inglés" rows="4">'.$equipos['descripcioni'].'</textarea>
                                      <input type="file" id="file_imagen" name="file_imagen"> 
                              </div>
                              <button class="btn btn-primary" type="submit">
                                MODIFICAR IMAGEN
                              </button> 
                              <a id="eliminar_imagen" onclick="borrar_equipo('.$equipos['id'].');" href="#" class="btn btn-danger" style="width:200px; height:40px;">
                                ELIMINAR
                              </a>   
                              <input type="text" id="id" name="id" value="'.$equipos['id'].'" style="opacity:0%">
                              <input type="text" id="opcion" name="opcion" value="4" style="opacity:0%"> 
                        </form>
                    </div> 
  </div>              </div>
</div>';
