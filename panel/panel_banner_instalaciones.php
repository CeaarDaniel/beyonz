...
if($_SESSION['permisos']!='1' ){
 ...
 $consulta_banner = $cone->prepare("select * from banner_instalaciones");  
?>

              <div class="container-fluid head-contenido">
                  <div class="d-flex justify-content-left">
                      <div class="p-2">
                         <h2>Banner instalaciones</h2>
                      </div>
                  </div>
              </div>
                                        ...
                                        <div class="col-sm-12 col-md-8">
                                            <div class="d-flex flex-wrap justify-content align-content-center" style="height:100%"> 
                                                <form id="modificar_imagen" 
                                                      ...
                                                      class="m-auto" 
                                                      method="post" 
                                                      action="crud_banner_instalaciones.php"
                                                      role="form" 
                                                      style="height:100%">
                                                      <div class="form-group">
                                                              <input type="file" id="file_imagen" name="file_imagen" required> 
                                                      ...
                                                      <input type="text" id="id" name="id" value="'.$fila['id'].'" style="opacity:0%">
                                                      <input type="text" id="opcion" name="opcion" value="3"  style="opacity:0%"> 
                                                </form>
                                            </div> 
                                        </div>
                                    </div> 
...
if (resultado) {
        ...
        fetch('./crud_banner_instalaciones.php', {
            method: 'POST',
            body: data
        })
