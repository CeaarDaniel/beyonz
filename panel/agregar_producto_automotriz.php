...
<form id="agregar_producto" action="borrar_planta.php" method=post  class="m-5 p-5 border border-dark rounded">
...
<div class="row">
  ...
  <div class="mb-3">
      ...
      <textarea minlength=5 maxlength=300  class="form-control mt-1" id="descripcioni" name="descripcioni" placeholder="escriba un texto en inglés" rows="8"></textarea>
  </div>
